...
export default function HomeView() {
  return (
      <Box sx={{ width: '100%', minHeight: 180, mt: 2, mx: 'auto', minHeight: '70vh', display:'flex', flexDirection:'column', justifyContent: 'center', alignItems: 'center'}}>
        <Grid container justifyContent="center" alignItems="center" columns={{xs:1, md:2}} sx={{width: '100%'}} spacing={5}>
          <Grid item size={1} sx={{width: {xs:'auto', md:540}, height: {xs:'auto', md:450}}} >
